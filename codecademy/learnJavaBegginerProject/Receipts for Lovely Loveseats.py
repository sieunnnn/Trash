#   This program stores the names and prices of a furniture store's catalog in variables.
#   And process the total price and item list of customers, printing them to the output terminal.
