# organize menus, franchises and business
...
class Franchiese:
    ...
    def __repr__(self):
        return "The restaurant is in {address}.".format(address = self.address)
...
flagship_store = Franchiese("1232 West End Road", [brunch, early_bird, dinner, kids, arepas_menu])
new_installment = Franchiese("12 East Mulberry Street", [brunch, early_bird, dinner, kids, arepas_menu])
...
arepas_place = Franchiese("189 Fitzgerald Avenue", [arepas_menu])
# New Business
apera = Business("Take a' Arepa", [arepas_place])