# This program helps to tally the number of sales during the day,
...
for temp in daily_transactions:
    daily_transactions_split.append(temp.split('_'))

# print(daily_transactions_split)


# remove space, and make two-dimensional array
transactions_clean = []
for daily_transaction in daily_transactions_split:
    transaction_clean = []
    for temp in daily_transaction:
        transaction_clean.append(temp.replace("\n", "").strip(" "))
...
for thread_sold in thread_sold:
    # print(thread_sold)
    for color in thread_sold.split('&'):
