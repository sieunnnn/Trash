...
public class EX112910 {
    public static void main(String[] args) throws IOException {
        ...
        <fall-Through 문>
        조건 값에 해당하는 case 절에 break 가 없으면 해당 case 절 뿐 아니라
        다음 break 를 만나기 전까지의 case 절과 default 절을 실행한다.
        의도적으로 break 를 생략해 모든 case 절과 default 절을 실행시키는 것을 fall-Through 문이라 한다.
        코드를 읽는 중 혼란스러울 여지가 있으므로 사용하지 않는 것을 권장한다.
