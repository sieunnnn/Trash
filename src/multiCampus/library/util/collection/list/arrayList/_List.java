...
public class _List {
    ...
    public void studyList() {
        ...
        // 2번 인덱스에 원하는 노래 인스턴스를 추가하세요.
        list.add(2, new Music("안예은", "문어의 꿈"));
        System.out.println("2번 인덱스에 원하는 노래 인스턴스를 추가하세요. : \n" + list);
        System.out.println("------------------------------------------------");
        ...
        // list 의 0~1번 인덱스 사이의 데이터를 잘라내어 새로운 List 로 반환받아 출력하세요.
        System.out.println("7. list 의 0~1번 인덱스 사이의 데이터를 잘라내어 새로운 List 로 반환받아 출력하세요. : \n" + list.subList(0, 1));
        System.out.println("------------------------------------------------");

        //8. 2번 인덱스에 new Music("김광석","서른즈음에")를 추가 하세요.
        //   새롭게 추가한 new Music("김광석","서른즈음에") 이 list 에 존재하는지 확인하고 결과를 출력하세요.
        //   결과가 false 가 나온다면 true 가 나오도록 코드를 수정해주세요.
        list.add(2, new Music("김광석", "서른즈음에"));
        System.out.println("8. 2번 인덱스에 new Music(\"김광석\",\"서른즈음에\")를 추가 하세요. : \n" + list);
        System.out.println("새롭게 추가한 new Music(\"김광석\",\"서른즈음에\") 이 list 에 존재하는지 확인 : " + list.contains(new Music("김광석", "서른즈음에")));
        System.out.println("------------------------------------------------");
